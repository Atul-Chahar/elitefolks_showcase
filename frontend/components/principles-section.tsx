  ...
  const principles = [
    {
      ...
      description: "Learn by doing. Write code and see immediate results against AI-powered test cases.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Your personal guide. Get stuck? Context-aware AI agents will help you find the solution.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        ...
        { text: "COURSES", highlight: true },
      ],
      description: "Comprehensive curriculum. From foundations directly into advanced architecture patterns.",
      align: "left",
    },
    {
      number: "04",
      ...
      description: "Apply your knowledge to real-world scenarios. Build confidence in shipping production code.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">WHY WE BUILD</h2>
      </div>
