  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className="mb-16">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">ELITEFOLKS</h2>
      </div>
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">EliteFolks</li>
            <li className="font-mono text-xs text-foreground/80">Creator Studio</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Appwrite</li>
            <li className="font-mono text-xs text-foreground/80">Python/AI</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="mailto:support@elitefolks.com"
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2026 EliteFolks. All rights reserved.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">Train AI, Build Code, Learn Faster.</p>
      </div>
    </section>
  )
}
