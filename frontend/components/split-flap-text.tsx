...
function SplitFlapTextInner({ text, className = "", speed = 50 }: SplitFlapTextProps) {
  ...
  return (
    <div
      className={`inline-flex gap-[0.08em] items-center cursor-pointer text-[clamp(2.5rem,11.5vw,16rem)] ${className}`}
      aria-label={text}
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 bottom-1/2 overflow-hidden">
          <div
            suppressHydrationWarning
            className="absolute inset-x-0 top-0 h-[200%] flex items-center justify-center leading-none transition-colors duration-150"
      ...
      <div className="absolute inset-x-0 top-1/2 bottom-0 overflow-hidden">
          <div
            suppressHydrationWarning
            className="absolute inset-x-0 bottom-0 h-[200%] flex items-center justify-center leading-none transition-colors duration-150"
            style={{ color: textColor }}
          >
            {currentChar}
          </div>
      ...
      >
        <div className="absolute inset-x-0 top-0 h-[200%] flex items-center justify-center leading-none transition-colors duration-150" style={{ color: textColor }}>
          {currentChar}
        </div>
      </motion.div>
    </motion.div>
