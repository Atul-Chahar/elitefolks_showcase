...
const signals = [
  {
    ...
    note: "Battle against peers or AI in real-time coding challenges. Rank up on the leaderboard.",
  },
  {
    date: "Recent",
    title: "Free Browser Compiler",
    note: "Instant, zero-setup access to Python, JavaScript, TypeScript, and C++ right in your browser.",
  },
  {
    date: "Recent",
    title: "DSA Mastery Tracks",
    note: "Structured curriculum designed specifically for technical interview preparation and algorithm mastery.",
  },
  {
    date: "Previous",
    title: "Logic Building Quests",
    note: "Interactive, bite-sized challenges to help beginners build core programming fundamentals.",
  },
  {
    date: "Previous",
    title: "Smart Editor Integration",
    note: "Full syntax highlighting, autocomplete, and error detection directly inside the web arena.",
  },
]
...
export function SignalsSection() {
  ...
  return (
    <section id="signals" ref={sectionRef} data-cursor-hide="true" className="relative py-32 pl-6 md:pl-28">
      <div
        ref={cursorRef}
        className={cn(
      ...
      <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">FEATURE SIGNALS</h2>
      </div>
