        ...
        <div className="min-h-screen pt-24 pb-12 px-4 flex items-center justify-center relative overflow-hidden bg-black selection:bg-orange-500/30 font-sans">
            ...
            <div className="w-full max-w-md relative z-10 flex flex-col items-center">
                    ...
                    <div className="bg-black/60 backdrop-blur-md rounded-[2.4rem] p-8 md:p-10 relative overflow-hidden border border-white/[0.02] shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
                        ...
                        <div className="text-center mb-10">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-500/20 bg-orange-500/5 mb-6">
                                ...
                                <span className="text-[10px] font-black text-orange-200 uppercase tracking-widest font-mono">Initialization Port</span>
                            </div>
                            <h1 className="font-[family-name:var(--font-bebas)] text-6xl tracking-wider text-white mb-2 leading-none uppercase italic pr-2">
                                SIGN <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600 pr-2">UP</span>
                            </h1>
                            <p className="text-zinc-500 text-xs font-medium uppercase tracking-[0.2em]">Start your voice coding journey</p>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="relative py-4">
                                ...
                                <div className="relative flex justify-center text-[10px] uppercase font-black tracking-[0.3em]">
                                    <span className="px-4 bg-black text-zinc-600">Credentials Required</span>
                                </div>
                            </div>

                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    <label htmlFor="name" className="text-[9px] font-black text-zinc-500 uppercase tracking-[0.3em] ml-2">Display Name</label>
                ...
                <p className="text-center text-zinc-600 mt-10 text-[10px] font-black uppercase tracking-[0.3em]">
                    ...
                    <Link href="/login" className="text-orange-500 hover:text-orange-400 transition-colors ml-2 underline underline-offset-4 decoration-orange-500/30">
                        Engage Session
                    </Link>
                </p>
            </div>
